...
from pygrams.pipelight import Pipelight
...
def get_args(command_line_arguments):
    ...
    parser.add_argument("-pt", "--prefilter_terms", type=int, default=25000,
...
def main(supplied_args):
    ...
    pipeline = Pipelight(doc_source_file_name, docs_mask_dict,
