...
//T: maybe try different focus in outputs, just to show different results and usage examples. For example here we could do -G physics or -Y or any other classification? similar below?
//
